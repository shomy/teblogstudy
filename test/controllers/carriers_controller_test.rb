...
class CarriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post carriers_url, params: { carrier: { content: @carrier.content, title: @carrier.title } }
    end
  ...
  test "should update carrier" do
    patch carrier_url(@carrier), params: { carrier: { content: @carrier.content, title: @carrier.title } }
